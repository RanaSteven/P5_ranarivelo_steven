    ...
    for (i = panier.length - 1; i >= 0; i--) {
        ...
        request2.onreadystatechange = function() {
            if (this.readyState == XMLHttpRequest.DONE && this.status == 200) {
                ...
                resume.innerHTML += "<div><img src='" + response.imageUrl + "' class='img-fluid mb-3'/></div>" + "<div class='text-center h3'>" + response.name + "</br><span class='text-danger font-weight-bold'>" + new Intl.NumberFormat("fr-FR", {style: "currency", currency : "EUR"}).format(response.price) + "</span></div>";
...
/*Faire les formats pour les prix des appareils.*/